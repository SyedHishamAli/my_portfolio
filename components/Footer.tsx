    ...
    <footer className="w-full pt-20 pb-10" id="contact">
      ...
      <div className="flex flex-col items-center">
        <h1 className="heading lg:max-w-[45vw]">
          Always up for talking about, Automation, AI Agents, or that one <span className="text-purple">BUG</span> that disappears right before the demo.
        </h1>
        ...
        <a
          href="https://mail.google.com/mail/?view=cm&fs=1&to=syedhisham197@gmail.com"
          target="_blank"
          rel="noreferrer"
        >
          <MagicButton
      ...
      <div className="flex mt-16 md:flex-row flex-col justify-between items-center">
        <p className="md:text-base text-sm md:font-normal font-light">
          Copyright © 2025 Syed Hisham Ali
        </p>
